...
var Tree = module.exports = React.createClass({
	...
	render: function () {
		var obj = this.props.object,
			...
			childNodes = isObject && (!('length' in obj) || obj.length < 256) ? Object.keys(obj).map(key => <li key={key}><Tree title={key} object={obj[key]} /></li>) : [],
		...
		return <div className="tree-node">
			<h5 onClick={this.toggle} className={className}>
				{this.props.title}
				: {isObject ? obj.constructor.name : typeof obj}
